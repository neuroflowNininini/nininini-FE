    ...
    <Container>
      ...
      <TopWrap id="hometop" >
        ...
        <Hang>
          <Tag>아이디</Tag>
          <InputBtnWrap>
            <Input1 value={id} // 입력 필드의 값은 상태 변수와 바인딩됩니다.
        ...
        <Hang>
          ...
          <Input value={pwConfirm} // 입력 필드의 값은 상태 변수와 바인딩됩니다.
            type='password'
        ...
        <Hang>
          <Tag>이름</Tag>
          <Input value={name} // 입력 필드의 값은 상태 변수와 바인딩됩니다.
            onChange={handleNameChange} // 입력 필드 값이 변경될 때 핸들러 호출           
          />
        </Hang>
        <Hang>
          <Tag>이메일</Tag>
          <Input value={email} // 입력 필드의 값은 상태 변수와 바인딩됩니다.
