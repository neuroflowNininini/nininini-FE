...
function App() {
  ...
  return (
    <div className="App" ref={scrollRef} style={{ overFlowY: "scroll", height: "calc(100vh - 50px)" }}>
      <BrowserView>
        데스크톱 브라우저
      </BrowserView>
      <MobileView>
        <HeaderNavMenu onTop={onTop} setOnTop={setOnTop}
