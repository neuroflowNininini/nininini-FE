    ...
    <Container>
      ...
      <TopWrap id="hometop" >
        <DescWrap >
          ...
          <Desc>
            선택하신 디자인의 제품을 추천해드려요!
          </Desc>
        </DescWrap>
        <CheckBoxWrap>
          <Checkbox checked={fall} onChange={setFall}>가을 느낌 낭낭한</Checkbox>
          <Checkbox checked={warm} onChange={setWarm}>따뜻한 색감 위주의</Checkbox>
          <Checkbox checked={cute} onChange={setCute}>귀엽고 알록달록한</Checkbox>
          <Checkbox checked={chic} onChange={setChic}>시크하고 도시적인</Checkbox>
          <Checkbox checked={simple} onChange={setSimple}>심플하고 자연스러운</Checkbox>
          <Checkbox checked={unique} onChange={setUnique}>유니크하고 독창적인</Checkbox>
        </CheckBoxWrap>
      </TopWrap>
