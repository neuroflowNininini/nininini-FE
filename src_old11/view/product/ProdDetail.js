  ...
  return (
    <TopWrap>
      ...
      <GrayWrap>
        ...
        <TabDiv onClick={() => setActiveTab('howto')} active={activeTab === "howto" ? "2.5px" : "0px"}>HOW TO</TabDiv>
      ...
      </GrayWrap>
      {
        activeTab === "info" ?
          <div style={{ paddingTop: "20px", paddingBottom: "100px" }}>
            <img src={product.detailPic} style={{ width: "100%" }} />
